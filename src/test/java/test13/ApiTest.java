...
import test13.bean.IUserService;
import test13.bean.UserService;
import test13.bean.UserServiceBeforeAdvice;
import test13.bean.UserServiceInterceptor;
...
public class ApiTest {
    ...
    public void init() {
        ...
        advisedSupport.setMethodMatcher(new AspectJExpressionPointcut("execution(* test13.bean.IUserService.*(..))"));
    }
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* test13.IUserService.*(..))");
